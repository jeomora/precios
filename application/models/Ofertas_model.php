...
class Ofertas_model extends MY_Model {
	...
	public function getOferton($where=[]){
		$this->db->select("o.id_oferta,o.fecha_registro,o.fecha_inicio,o.fecha_termino,o.id_producto,o.codigo,o.nombre,o.precio,o.nombre,o.maximo,o.estatus,o.tipo,p.codigo, u.ides,l.iva,p.ums,lo.estatus as liston,pz.preciouno,pz.preciocinco")
		->from("ofertas o")
