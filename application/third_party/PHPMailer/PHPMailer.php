...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'cedisazteca108@hotmail.com';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'imap.secureserver.net';
   ...
   * @var string
   */
  public $Username      = 'soporte@abarrotesazteca.com';
 ...
 */
  ...
  */
  ...
  public function MsgHTML($message, $basedir = '') {
    ...
    $this->Body = $message;
    if (empty($this->AltBody)) {
        $textMsg = trim(strip_tags(preg_replace_callback('/<(head|title|style|script)[^>]*>.*?<\/\\1>/s', '', $message)));
        if (!empty($textMsg)) {
