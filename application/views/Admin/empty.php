				...
				<div class="bg-white rounded p-4 d-flex flex-grow-1 flex-sm-grow-0">
					...
					<form class="form d-flex align-items-md-center flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
						...
						<div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
							...
							<input type="text" class="form-control border-0 font-weight-bold pl-2" placeholder="Category" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-target="kt_searchbar_7_category-options" data-offset="0,10" readonly />
						...
						<div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
							...
							<input id="kt_subheader_7_location" type="text" class="form-control border-0 font-weight-bold pl-2" placeholder="Location" data-toggle="modal" aria-haspopup="true" aria-expanded="false" data-target="#subheader7Modal" readonly />
						</div>
						<!--end::Input-->
