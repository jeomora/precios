                            ...
                            <div class="d-flex align-items-start justify-content-start flex-grow-1 bg-light-info p-8 card-rounded flex-grow-1 position-relative">
                                <div class="d-flex flex-column align-items-start flex-grow-1 h-100">
                                    <div class="p-1 flex-grow-1">
                                        <h4 class="text-info font-weight-bolder">ASIGNAR IMAGENES A PRODUCTOS CEDIS</h4>
                                        <p class="text-dark font-weight-bold mt-3">
                                            En el próximo apartado podrá asignar una imagen a cada uno de los productos en el catálogo del cedis<br>Debido a que son más de 15,000 productos favor de asignar imagen principalmente a los productos que se encuentrán en oferta.<br>
                                            También se mostrarán las frutas y verduras siendo los productos con más ofertas.
                                        </p>
