                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
                	...
                	<div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
                		...
                		<div class="text-dark order-2 order-md-1">
                			...
                			<a class="text-dark-75 text-hover-primary">Abarrotes Azteca</a>
                		</div>
                		<!--end::Copyright-->

                		<!--begin::Nav-->
                		<div class="nav nav-dark order-1 order-md-2">
                			<a class="nav-link pl-3 pr-0"></a>
                		</div>
                		<!--end::Nav-->
                	</div>
                	<!--end::Container-->
        ...
        <!--begin::Modal CAMBIO DE CONTRASEÑA-->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo form_close(); ?>
                        <p id="pass_error" style="display:none">Las contraseñas no coinciden, por favor inténtelo nuevamente</p>
                    </div>
        ...
        <!--begin::Modal CAMBIO DE IMAGEN -->
        <div class="modal fade" id="kt_modal_img" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <?php echo form_open("", array("id"=>'form_usuario_edit33')); ?>
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="owl-carousel owl-theme" id="owledit33">
                                    <?php if($svgs33):foreach ($svgs33 as $key => $vals): ?>
                                        <div class="symbol symbol-100 mr-5">
                                            <div class="marcos33" data-id-cual="<?php echo $vals->id_avatar ?>">
                                                <div class="symbol-label" style="background-image:url('assets/media/svg/avatars/<?php echo $vals->nombre ?>.svg');">
                                                </div>  
                                            </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary update_usuario33">Editar Usuario</button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                <h3 class="font-weight-bold m-0">
                    Perfil de usuario
                    <small class="text-muted font-size-sm ml-2">Sin mensajes</small>
                </h3>
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" style="background-image:url('assets/media/svg/avatars/<?php echo $usuario['imagen'] ?>.svg')"  data-toggle='modal' data-target='#kt_modal_img'></div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1">
                            <?php echo strtoupper($usuario['grupo']) ?>
                        </div>
                        <div class="navi mt-2">
                            <a class="navi-item">
                                <span class="navi-link p-0 pb-2">
                                    ...
                                    <span class="navi-text text-muted text-hover-primary"><?php echo strtoupper($usuario['email']) ?></span>
                                </span>
                            </a>
                            <a href="<?php echo base_url('Inicio/Logout') ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cerrar Sesión</a>
                        </div>
                    </div>
                </div>
                <!--end::Header-->
                ...
                <div class="navi navi-spacer-x-0 p-0">
                    <!--begin::Item-->
                    <a class="navi-item" data-toggle='modal' data-target='#kt_modal_img' style="cursor:pointer;">
                        <div class="navi-link">
                    ...
                    <!--end:Item-->
                    <!--begin::Item-->
                    <a class="navi-item" data-toggle='modal' data-target='#kt_modal_90' style="cursor:pointer;">
                        <div class="navi-link">
                            <div class="symbol symbol-40 bg-light mr-3">
                                <div class="symbol-label">
                                    <span class="svg-icon svg-icon-md svg-icon-success">
                    ...
                    <a href="custom/apps/user/profile-3.html"  class="navi-item">
                        <div class="navi-link">
                            ...
                            <div class="navi-text">
                                ...
                                <div class="text-muted">
                                    Inbox and tasks<span class="label label-light-danger label-inline font-weight-bold">update</span>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <script src="assets/js/pages/widgets.js?v=1.0"></script>
        <!--end::Page Scripts-->

        <!--end::Page Vendors -->
        <?php if (isset($scripts) && $scripts): ?>
            <?php foreach ($scripts as $row): ?>
            <script type="text/javascript" src="<?php echo base_url($row.'.js?ver=4.9.2') ?>"></script>
            <?php endforeach ?>
        <?php endif ?>
    </body>
    <!--end::Body-->
