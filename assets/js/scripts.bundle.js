...
function setZeros2(dude){
    var regresa = dude;
    var longi = regresa.length;
    for (var i = 0;i <= (4-longi);i++) {
        regresa = "0"+regresa;
    }
    regresa = "GEN SUCA21-"+regresa;
    return regresa;
}

function setZeros3(dude){
    var regresa = "0"+dude;
    var longi = regresa.length;
    for (var i = 0;i <= (5-longi);i++) {
        regresa = "0"+regresa;
                ...
                events: [
                    {
                        title: 'N000012',
                        start: '2020-07-12',
                        description: 'Pago nota, 19 Hermanos',
                    ...
                    },
                    {
                        title: 'N000023',
                        start: '2020-07-11',
                        description: 'Pago nota, SCORPION',
                        className: "fc-event-primary",
                        editable: false,
                    },{
                        title: 'N0002',
                    ...
                    },
                    {
                        title: 'SAA00001',
                        start: YM + '-31',
                        description: 'Pago de la sucursal Solidaridad',
