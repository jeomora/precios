    ...
    qrmeup().done(function(resp){
        ...
        if(resp){
            ...
            $.each(resp,function(index,value){
                ...
                if(value.pre11 <= 0 ){
                    $('#outtxt'+index).append("<h1>EL <span style='font-weight:bold'>PRECIO 1 APARECE EN CEROS</span>, POR FAVOR REVISE EL PRECIO E INTENTELO NUEVAMENTE</h1>")
                }else if(value.pre22 <= 0 ){
                    $('#outtxt'+index).append("<h1>EL <span style='font-weight:bold'>PRECIO 2 APARECE EN CEROS</span>, POR FAVOR REVISE EL PRECIO E INTENTELO NUEVAMENTE</h1>")
                }else if(value.pre33 <= 0 ){
                    $('#outtxt'+index).append("<h1>EL <span style='font-weight:bold'>PRECIO 3 APARECE EN CEROS</span>, POR FAVOR REVISE EL PRECIO E INTENTELO NUEVAMENTE</h1>")
                }else if(value.rdiez <= 0 ){
                    $('#outtxt'+index).append("<h1>EL <span style='font-weight:bold'>PRECIO DEL RENGLON 10 APARECE EN CEROS</span>, POR FAVOR REVISE EL PRECIO E INTENTELO NUEVAMENTE</h1>")
                }else{
...
function qrmeup() {
    return $.ajax({
        url: site_url+"Codigos/qrmeupB/"+window.location.pathname.split("/").pop(),
        type: "POST",
        cache: false,
    });
}
