...
<head>
	 {% block head %}
            {{ Html.Meta("utf8") }}
            {{Html.LinkCss(["bootstrap","font-awesome.min","jquery.bxslider.min","general","general2","general3","favicon","font-awesome.min","fonts"])}}
    {% endblock %}
  ...
  <div class="container-fluid navigation">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li {{ Control == "Conoce" ? 'class="activo"' : '' }} ><a href="conoce">Conoce</a></li>
...
<footer>
  <div class="col-md-12 col-xs-12 footer-menu">
    <div class="col-md-12">
      <div class="col-md-3">
        {{Html.Img("templates/fundacion/fileimages/logo.svg",{link:"#", class:"img-responsive"})}}
 ...
 {{Javascript.Js(["jquery","jquery-ui","jquery.filer","jquery.filer.min","custom","component","bootstrap.min","bootstrap-table","bootstrap-table-es", "bootstrap-dialog.min","bootstrap-arrastrar","tinymce/tinymce.min","select2","localstore","funciones","jform","validator","init","jquerycookie","jquery.waypoints", "progressbar.min","jquery.bxslider.min", "home"])}}
</body>
</html>